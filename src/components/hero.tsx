...
export function Hero() {
  ...
  return (
    <section className="relative h-[85vh] md:h-screen w-full flex items-center justify-center overflow-hidden bg-background">
      <motion.div 
      ...
      <div className="relative z-20 text-center space-y-4 w-full max-w-7xl px-6 flex flex-col items-center">
        <motion.div
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 1, duration: 1 }}
        >
          <span className="text-[9px] md:text-[10px] font-bold tracking-[1em] text-black/60 uppercase">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-[0.4em] uppercase leading-none text-black font-headline">
            {content.title}
          </h1>
        </motion.div>
        ...
        <motion.p 
          ...
          className="text-[9px] md:text-[10px] text-black/80 max-w-2xl mx-auto tracking-[0.6em] uppercase font-light"
        >
          {content.tagline}
        </motion.p>
      </div>
