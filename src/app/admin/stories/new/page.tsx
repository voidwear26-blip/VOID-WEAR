  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      try {
        ...
        toast({ title: "ASSET COMPRESSED", description: "LOCAL NARRATIVE VISUAL READY." });
      } catch (err) {
        toast({ variant: "destructive", title: "COMPRESSION_FAILURE", description: "SYSTEM COULD NOT PROCESS HIGH-RES BUFFER." });
      }
    }
  };
