        ...
        await resend.emails.send({
          ...
          html: `
            <div style="background-color: #f9f9f9; color: #000; padding: 40px; font-family: 'Space Grotesk', sans-serif; border: 1px solid #eee;">
              <h1 style="border-bottom: 1px solid #eee; padding-bottom: 20px; font-size: 20px; letter-spacing: 0.3em; text-transform: uppercase;">ORDER CONFIRMED</h1>
              <div style="margin-top: 30px;">
                <p style="color: #666; font-size: 10px; letter-spacing: 0.1em; margin-bottom: 5px; text-transform: uppercase;">UPDATE</p>
                <p style="font-size: 14px; line-height: 1.6; color: #333;">${emailBody}</p>
              </div>
              <div style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;">
                 <p style="color: #666; font-size: 10px; letter-spacing: 0.1em; margin-bottom: 10px; text-transform: uppercase;">ORDER SUMMARY</p>
        ...
        await resend.emails.send({
          ...
          html: `
            <div style="background-color: #000; color: #fff; padding: 40px; font-family: 'Space Grotesk', sans-serif; border: 1px solid #333;">
              ...
              <div style="margin-top: 30px;">
                <p style="color: #666; font-size: 10px; letter-spacing: 0.1em; margin-bottom: 5px; text-transform: uppercase;">ORDER ID</p>
              ...
              <div style="margin-top: 30px; border-top: 1px solid #333; padding-top: 20px;">
                 <p style="color: #666; font-size: 10px; letter-spacing: 0.1em; margin-bottom: 10px; text-transform: uppercase;">ITEMS</p>
