      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-32">
          <div className="space-y-8 text-center md:text-left">
            <span className="text-xs font-bold tracking-[0.6em] text-white/70 uppercase">OUR STORY // MANIFESTO</span>
            ...
            <p className="text-xl md:text-2xl text-white/90 font-light tracking-widest leading-relaxed uppercase">
          ...
          <div className="grid md:grid-cols-2 gap-24">
            <div className="space-y-6">
              ...
              <p className="text-sm text-white/70 tracking-widest leading-relaxed uppercase">
