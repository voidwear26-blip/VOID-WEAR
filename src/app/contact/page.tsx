            ...
            <div className="space-y-8">
              <div className="flex items-center gap-6 group">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs tracking-widest uppercase">voidwear26@gmail.com</p>
                </div>
              </div>
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input className="bg-black/50 border-white/10 rounded-none h-12 text-xs tracking-widest focus:border-white/40 text-white" placeholder="IDENTIFICATION" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold tracking-widest text-white/40 uppercase">EMAIL ADDRESS</label>
                  <Input className="bg-black/50 border-white/10 rounded-none h-12 text-xs tracking-widest focus:border-white/40 text-white" placeholder="COMM-CHANNEL" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-bold tracking-widest text-white/40 uppercase">SUBJECT</label>
                <Input className="bg-black/50 border-white/10 rounded-none h-12 text-xs tracking-widest focus:border-white/40 text-white" placeholder="TOPIC" />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-bold tracking-widest text-white/40 uppercase">MESSAGE</label>
                <Textarea className="bg-black/50 border-white/10 rounded-none min-h-[150px] text-xs tracking-widest focus:border-white/40 text-white" placeholder="INPUT DATA..." />
              </div>
              <Button className="w-full bg-white text-black hover:bg-white/90 h-16 text-xs font-bold tracking-[0.5em] rounded-none shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all">
                SEND TRANSMISSION
